...
// //             <dd className="mt-2 text-base text-white/80">{item.answer}</dd>
// //           </div>
// //         ))}
// //       </dl>
// //     </div>
...
//           <div key={item.question} className="border-b border-white/20 pb-4">
//             <dt>
//               <button
//                 className="flex justify-between items-center w-full text-left text-lg font-bold text-white hover:text-white/80 transition-colors duration-200 py-2"
...
//               }`}
//             >
//               <div className="text-base text-white/80 pb-2">
//                 {item.answer}
//               </div>
//             </dd>
//           </div>
